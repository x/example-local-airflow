...
airflow connections --add \
    ...
    --conn_uri="docker://oauth2accesstoken:$(gcloud auth application-default print-access-token)@gcr.io/oden-qa"
...
airflow connections --add \
  ...
  --conn_uri="gcpcloudsql://airflow:${CLOUDSQL_POSTGRES_PASSWORD}@1.1.1.1:3306/postgres?database_type=postgres&project_id=oden-qa&location=${GCLOUD_REGION}&instance=${CLOUDSQL_POSTGRES_DB_NAME}&use_proxy=True&sql_proxy_use_tcp=False"
